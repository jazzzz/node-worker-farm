...
process.on('message', function (data) {
    console.log('[%s] Received message: %s', process.pid, data.module ? 'module to load' : 'other');
  if (!$module && !data.module) { console.log('[%s] node $module and no module in data. data:', process.pid, data); }
